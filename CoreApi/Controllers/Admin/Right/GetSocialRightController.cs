...
namespace CoreApi.Controllers.Admin.Right
{
    ...
    public class GetSocialRightController : BaseController
    {
        ...
        [HttpGet("")]
        public async Task<IActionResult> GetSocialRights([FromServices] AdminUserManagement __AdminUserManagement,
                                                         ...
                                                         [FromHeader(Name = "session_token_admin")] string SessionToken)
        {
            ...
            try {
                ...
                if (Error == ErrorCodes.USER_DOES_NOT_HAVE_PERMISSION) {
                    return Problem(400, RESPONSE_MESSAGES.NOT_ALLOW_TO_DO, new string[]{ "see social rights" });
                }
                #endregion

                #region Get all rights
                var (Rights, TotalSize) = await __SocialUserManagement.GetRights();
                var Ret = new JArray();
