...
namespace CoreApi.Controllers.Social.Category
{
    [ApiController]
    [Route("/api/category")]
    public class GetTrendingCategoriesController : BaseController
    {
        ...
        public GetTrendingCategoriesController(BaseConfig _BaseConfig) : base(_BaseConfig)
        {
        }
        ...
        public async Task<IActionResult> GetTrendingCategories([FromServices] SessionSocialUserManagement    __SessionSocialUserManagement,
