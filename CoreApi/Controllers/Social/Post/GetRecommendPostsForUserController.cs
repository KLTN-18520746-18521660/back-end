...
namespace CoreApi.Controllers.Social.Post
{
    ...
    public class GetRecommendPostsForUserController : BaseController
    {
        ...
        {
            __ControllerName = "GetRecommendPostsForUser";
            LoadConfig();
        }
        ...
        [HttpGet("user/{user_name}/4")]
        // [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(GetUserBySessionSocialSuccessExample))]
        // [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(StatusCode400Examples))]
        // [ProducesResponseType(StatusCodes.Status404NotFound, Type = typeof(StatusCode404Examples))]
        // [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(StatusCode500Examples))]
        public async Task<IActionResult> GetRecommendPostsForUser([FromServices] SessionSocialUserManagement __SessionSocialUserManagement,
