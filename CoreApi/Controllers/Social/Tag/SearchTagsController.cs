...
namespace CoreApi.Controllers.Social.Tag
{
    ...
    public class SearchTagsController : BaseController
    {
        public SearchTagsController(BaseConfig _BaseConfig) : base(_BaseConfig)
        {
        }

        [HttpGet("")]
        public async Task<IActionResult> SearchTags([FromServices] SessionSocialUserManagement    __SessionSocialUserManagement,
