...
namespace CoreApi.Controllers.Social.User
{
    ...
    public class SocialUserForgotPasswordController : BaseController
    {
        ...
        public async Task<IActionResult> SendRequestForgotPassword([FromServices] SocialUserManagement  __SocialUserManagement,
                                                                   ...
                                                                   [FromBody] ForgotPasswordModel       __ModelData)
        {
            ...
            try {
                ...
                var RequestTimeout                  = GetConfigValue<int>(CONFIG_KEY.SOCIAL_FORGOT_PASSWORD_CONFIG, SUB_CONFIG_KEY.TIMEOUT);
        ...
        [ProducesResponseType(StatusCodes.Status410Gone, Type = typeof(StatusCode410Examples))]
        [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(StatusCode500Examples))]
        public async Task<IActionResult> GetInfoRequest([FromServices] SocialUserManagement __SocialUserManagement,
