            ...
            modelBuilder.Entity("DatabaseAccess.Context.Models.AdminUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e0bafe8b-0dee-4117-93e2-cbe192dfa536"),
                            CreatedTimestamp = new DateTime(2022, 3, 30, 20, 12, 18, 410, DateTimeKind.Utc).AddTicks(2566),
                            DisplayName = "Administrator",
                            Email = "admin@admin",
                            Salt = "beb799f7",
                            SettingsStr = "{}",
                            StatusStr = "Readonly",
                            StorePassword = "16535F117D2D633E5E4B1309FCA7713A",
                            UserName = "admin"
                        });
                });
            ...
            modelBuilder.Entity("DatabaseAccess.Context.Models.AdminUserRoleOfUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("e0bafe8b-0dee-4117-93e2-cbe192dfa536"),
                            RoleId = 1
                        });
                });
            ...
            modelBuilder.Entity("DatabaseAccess.Context.Models.SocialCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedTimestamp = new DateTime(2022, 3, 30, 20, 12, 18, 440, DateTimeKind.Utc).AddTicks(8220),
                        ...
                        {
                            Id = 2L,
                            CreatedTimestamp = new DateTime(2022, 3, 30, 20, 12, 18, 440, DateTimeKind.Utc).AddTicks(8306),
                        ...
                        {
                            Id = 3L,
                            CreatedTimestamp = new DateTime(2022, 3, 30, 20, 12, 18, 440, DateTimeKind.Utc).AddTicks(8311),
                        ...
                        {
                            Id = 4L,
                            CreatedTimestamp = new DateTime(2022, 3, 30, 20, 12, 18, 440, DateTimeKind.Utc).AddTicks(8316),
                        ...
                        {
                            Id = 5L,
                            CreatedTimestamp = new DateTime(2022, 3, 30, 20, 12, 18, 440, DateTimeKind.Utc).AddTicks(8323),
            ...
            modelBuilder.Entity("DatabaseAccess.Context.Models.SocialPost", b =>
                {
                    ...
                    b.HasIndex(new[] { "Slug" }, "IX_social_post_slug")
                        .IsUnique()
                        .HasFilter("(status) = 'Approved' AND (slug) <> 'd'");
            ...
            modelBuilder.Entity("DatabaseAccess.Context.Models.SocialTag", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedTimestamp = new DateTime(2022, 3, 30, 20, 12, 18, 461, DateTimeKind.Utc).AddTicks(54),
                            Describe = "Angular",
                            StatusStr = "Readonly",
                            Tag = "#angular"
                        },
                        ...
                        {
                            Id = 2L,
                            CreatedTimestamp = new DateTime(2022, 3, 30, 20, 12, 18, 461, DateTimeKind.Utc).AddTicks(112),
                        ...
                        {
                            Id = 3L,
                            CreatedTimestamp = new DateTime(2022, 3, 30, 20, 12, 18, 461, DateTimeKind.Utc).AddTicks(117),
                        ...
                        {
                            Id = 4L,
                            CreatedTimestamp = new DateTime(2022, 3, 30, 20, 12, 18, 461, DateTimeKind.Utc).AddTicks(122),
                            Describe = "Nothing in here",
                            StatusStr = "Readonly",
                            Tag = "#nothing"
                        },
                        ...
                        {
                            Id = 5L,
                            CreatedTimestamp = new DateTime(2022, 3, 30, 20, 12, 18, 461, DateTimeKind.Utc).AddTicks(126),
                            Describe = "hi hi",
                            StatusStr = "Readonly",
                            Tag = "#hihi"
                        });
