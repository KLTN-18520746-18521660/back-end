...
namespace DatabaseAccess.Migrations
{
    ...
    [Migration("DBCreation_03")]
    partial class DBCreation_03
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DatabaseAccess.Context.Models.AdminBaseConfig", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            StatusStr = "Enabled",
                            ValueStr = "{\"visted_factor\":5,\"views_factor\":1,\"likes_factor\":2,\"comments_factor\":1,\"tags_factor\":100,\"categories_factor\":100,\"common_words_factor\":500,\"ts_rank_factor\":10,\"common_words_size\":10,\"max_size\":50}"
                        },
                        new
                        {
                            Id = 19,
                            ...
                            StatusStr = "Enabled",
                            ValueStr = "{\"visted_factor\":5,\"views_factor\":1,\"likes_factor\":2,\"comments_factor\":1,\"tags_factor\":100,\"categories_factor\":100,\"common_words_factor\":500,\"common_words_size\":10,\"ts_rank_factor\":10,\"max_size\":50}"
                        });
                });
            ...
            modelBuilder.Entity("DatabaseAccess.Context.Models.RedirectUrl", b =>
                {
                    b.Property<string>("Url")
                        .HasColumnType("text")
                        .HasColumnName("url");

                    b.Property<long>("Times")
                        .HasColumnType("bigint")
                        .HasColumnName("times");

                    b.HasKey("Url");

                    b.ToTable("redirect_url");

                    b.HasCheckConstraint("CK_redirect_url_times_valid_value", "(times >= 0)");
                });
